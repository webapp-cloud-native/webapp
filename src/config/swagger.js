...
**Authentication**: HTTP Basic Authentication using email as username and password.
...
- Quantity must be between 0-100 and a multiple of 1`,
    ...
    components: {
      securitySchemes: {
        basicAuth: {
          type: 'http',
          scheme: 'basic',
          description: 'HTTP Basic Authentication. Use email as username and password. Example: Authorization: Basic base64(email:password)'
        }
      },
      schemas: {
        User: {
          ...
          properties: {
            ...
            email: {
              type: 'string',
              format: 'email',
              description: 'User email address (used as username for authentication)',
        ...
        Product: {
          ...
          properties: {
            ...
            description: {
              ...
              example: 'A high-quality professional widget designed for enterprise use'
            },
            sku: {
              type: 'string',
              minLength: 1,
            ...
            quantity: {
              ...
              maximum: 100,
              multipleOf: 1,
              description: 'Product quantity in stock (0-100, must be whole number)',
              example: 50
            },
            date_added: {
              type: 'string',
    ...
    tags: [
      {
        name: 'Health Check',
        description: 'Application health monitoring and database connectivity testing'
      },
      {
        name: 'User Management',
        description: 'User registration, authentication, and profile management operations'
      },
      {
        name: 'Product Management',
        description: 'Product CRUD operations with ownership-based access control'
      }
    ]
  },
  apis: [
